...
const treatments = [
  ...
  { id: "implant",    label: "04 · IMPLANTS",   title: "IMPLANTOLOGIE DENTAIRE",     desc: "Solution moderne et durable, l'implant dentaire remplace une dent manquante avec un rendu parfaitement naturel. Intégré avec précision dans l'os grâce à une racine en titane biocompatible, il offre confort, stabilité et élégance pour retrouver un sourire harmonieux en toute confiance.",                                                                         features: ["SOLUTION FIXE", "OS PRÉSERVÉ", "GARANTIE LONGUE DURÉE"],       img: implantImg },
